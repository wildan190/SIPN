                    ...
                    <form method="POST" action="{{ route('admin.alumni.update', $alumni->id) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="almamater" id="almamater"
                                value="{{ old('almamater', $alumni->almamater) }}" required
                                class="mt-1 block w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                            @error('almamater')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="address" name="address" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">{{ old('address', $alumni->address) }}</textarea>
                            @error('address')
                        ...
                        <div class="mb-4">
                            ...
                            @if ($alumni->picture_upload)
                                <div class="mt-2">
                                    <img src="{{ Storage::url($alumni->picture_upload) }}" alt="Profile Picture"
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <button type="submit"
                                class="inline-block bg-blue-500 text-white font-medium px-4 py-2 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                                Update Alumni
                            </button>
                        </div>
                    </form>
